...
Before designing any architecture, ALWAYS read these context files:

1. **MANDATORY** - Project Understanding:
   - `context/project/project-context.md` — Current project conventions and patterns

2. **ARCHITECTURAL FOUNDATIONS** - Always read:
   - `context/core/essential-patterns.md` — Core patterns for error handling, validation, security
   - `context/core/anti-simulation-directive.md` — Important behavioral constraints

3. **DOMAIN-SPECIFIC PATTERNS** - Read based on architecture domain:
   - Backend systems: `context/backend/domain-patterns.md`, `context/backend/nestjs-clean-architecture.md`
   - Frontend systems: `context/frontend/react-compound-patterns.md`, `context/frontend/react-query-patterns.md`
   - Web applications: `context/domains/web-development.md`

4. **TOOLING CONSIDERATIONS** - When relevant:
   - `context/tooling/biome-bun-docker.md` — Current tooling setup and constraints

**CRITICAL**: Use Read tool to load relevant context before making architectural decisions. Your designs must align with existing project patterns and constraints.
