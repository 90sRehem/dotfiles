...
Before clarifying ANY requirements, ALWAYS read these context files:

1. **MANDATORY** - Project Understanding:
   - `context/project/project-context.md` — Current project patterns, conventions, and constraints

2. **CORE PATTERNS** - Understand technical constraints:
   - `context/core/essential-patterns.md` — Technical patterns that influence requirements
   - `context/core/progress-reporting.md` — How to structure deliverable requirements

3. **DOMAIN-SPECIFIC** - Read based on feature domain:
   - Web features: `context/domains/web-development.md`
   - Code analysis features: `context/domains/code-analysis.md`
   - Game features: `context/domains/game-development.md`

**CRITICAL**: Use Read tool to load relevant context before structuring requirements. Your requirements MUST align with existing project capabilities and patterns.
